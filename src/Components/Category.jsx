...
const Category = () => {
    return (
        <div className='lg:w-[1240px] mx-auto'>
            ...
            <div className='grid sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-6 grid-cols-4 lg:my-16 ml-5'>
                
 <div className="card w-36 h-36 bg-base-100 hover:shadow-xl shadow-sm">
  <figure className="">
 ...
 <div className="card w-36 h-36 bg-base-100 hover:shadow-xl shadow-sm">
  ...
  <div className=" items-center text-center">
    <h2 className="font-bold text-center">Boat Tour</h2>
    <p>10 Tours+</p>
 ...
 <div className="card w-36 h-36 bg-base-100 hover:shadow-xl shadow-sm">
  ...
  <div className=" items-center text-center">
    <h2 className="font-bold text-center">Advancer</h2>
    <p>10 Tours+</p>
