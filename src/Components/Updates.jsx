...
const Updates = () => {
    return (
        <div className='my-10 lg:w-[1240px] mx-auto'>
            ...
            <div className='grid sm:grid-cols-1 lg:grid-cols-2 gap-4 mt-10 p-16 mx-auto'>
{/* first Card */}
 ...
 {/* Third Card             */}
  ...
  <div className="card-body">
    ...
    {/* Adding 4 extra Image  */}
            <div className='grid sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 grid-cols-2 mx-auto px-10 gap-10 mt-10'>
